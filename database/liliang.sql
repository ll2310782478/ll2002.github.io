...
(26, 1, 1, 'admin', '2022-11-28 03:49:52', 0);
...
(10, 'Redmi-Note-12-5G', 1199, '三星OLED|护眼屏|骁龙5G芯｜5000mAh|电量', 'sp1.webp', NULL),
(18, 'Redmi-Note-12-Pro', 1899, 'IMX766-防抖相机-OLED', 'sp2.webp', 30),
(19, 'Redmi-Note-12-Pro+', 2599, '2亿超清防抖相机-OLED-柔性直屏', 'sp3.webp', 20),
(20, 'Redmi-Note-11-5G', 1099, '双卡双5G|X轴线性马达|5000mAh大电量|33W快充|立体声双扬声器|天玑810处理器|90Hz变速高刷屏', 'sp4.webp', 30),
...
(24, 'Redmi-K50-至尊版', 2799, '骁龙8+「狂暴调校」｜定制-1.5K旗舰直屏｜120W神仙秒充丨1亿像素光学防抖相机｜电竞级VC散热|屏下指纹', 'sp8.webp', 50);
...
--
ALTER TABLE `sp`
  MODIFY `spid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
