<?php
    ...
    if(mysqli_num_rows($result)>0){
        ...
        echo "两次密码不一致，请重新<a href=register.html>注册</a>！";
        
        
        // return false;
    }
    else{
    $sql="insert into usertable(username,userpwd,reuserpwd,flag) values('$uname','$upass','$reupass',0)";
